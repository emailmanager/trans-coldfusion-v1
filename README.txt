This is a ColdFusion Component for interacting with the Emailmanager (www.emailmanager.com) API.
...
Pretty easy to use.  Drop the emailmanagerapi.cfc in with your files and invoke it like so:

<cfinvoke component="EmailManagerAPI" method="sendMail" returnVariable="pmCode">
...
apiKey		: the API key for the Emailmanager "server" you're using
...
The component returns a single variable #pmCode# that is the status code returned from Emailmanager.
